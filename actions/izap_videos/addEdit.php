...
$uploaded_file = elgg_get_uploaded_file('videoImage');
...
if ($uploaded_file) {
	$izap_videos->deleteIcon();
	$izap_videos->saveIconFromUploadedFile('videoImage');
} 
